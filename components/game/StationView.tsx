          ...
          <div className={`space-y-4 ${station.challenge ? '' : 'lg:col-start-2 lg:row-start-2'}`}>
            {!isSelfSolvingPuzzle && (
              <div className={`rounded-2xl p-5 space-y-4 ${isLibrary ? 'library-panel border' : 'bg-[#101616] border border-[#00FBFB]/15'}`}>
                ...
                {(!station.challenge || station.challenge.type === 'cipher' || station.challenge.type === 'cipherWheels' || station.challenge.type === 'clockPuzzle') && (
                  <input
                    ref={answerInputRef}
                    type="text"
                    value={answer}
            ...
            <div className="border border-[#3a4a49]/40 rounded-xl p-4 space-y-3 lg:col-start-2">
              ...
              {!showReveal ? (
                ...
                <div className="space-y-3 text-center">
                  <p
                    className="text-[#00FBFB] font-headline font-bold text-2xl tracking-widest"
